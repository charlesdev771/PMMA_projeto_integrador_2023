...
<div id="header" class="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-warning">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                ...
                <li class="nav-item">
                    <a class="menu_item active" href="about.php">
                        Sobre
                    </a>
                </li>
                <li class="nav-item">
                    <a class="menu_item active" href="Prevention.php">
                        Prevenção
                    </a>
                    </li>
                    <li class="nav-item">
                    <a class="menu_item active" href="Causes.php">
                        Causas
                    </a>
                    </li>
                    <li class="nav-item">
                    <a class="menu_item active" href="Types.php">
                        Tipos
                    </a>
                    </li>
                    <li class="nav-item">
                    <a class="menu_item active" href="Treatment.php">
                        Tratamento
                    </a>
                    </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 col-md-9">
                            <h1 class="text-left text-dark mt-5">
                                Sobre o livro: 
                            </h1>
                        ...
                        <div class="col-sm-12 col-md-3 mt-5">
                            <figure>
                                <img src="../static/imgs/mentes1.jpg" class="ml-5">
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <!--Beginning about project-->

    <div id="ABOUTPROJECT" class="ABOUTPROJECT">
        <div id="aboutproject" class="aboutproject">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-md-9">
    ...
    <!--Beginning about Us-->
        ...
        <div id="ABOUTUS" class="ABOUTUS">
            <div id="aboutus" class="aboutus bg-warning">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-3">
                            <figure>
                                <img src="../static/imgs/perfil.jpg">
                            </figure>
                            <h5 class="text-center text-light">
                                Unknow
                            </h5>
                            <p class="text-center">is simply dummy text</p>
                        </div>
    ...
    <footer class="text-dark">
        ...
        <div class="col-4">
            ...
            <li class="nav-link">
                <a href="Prevention.php" class="text-light">
                Prevenção
                </a>
            </li>   
            <li class="nav-link">
                <a href="Causes.php" class="text-light">
                Causas
                </a>
            </li>
            <li class="nav-link">
                <a href="Types.php" class="text-light">
                Tipos
                </a>
            </li> 
            <li class="nav-link">
                <a href="Treatment.php" class="text-light">
                Tratamento
                </a>
            </li>        
